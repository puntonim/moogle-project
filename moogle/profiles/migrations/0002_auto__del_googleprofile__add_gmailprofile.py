...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GmailProfile'
        db.create_table('profiles_gmailprofile', (
        ...
        db.send_create_signal('profiles', ['GmailProfile'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GmailProfile'
        db.delete_table('profiles_gmailprofile')
