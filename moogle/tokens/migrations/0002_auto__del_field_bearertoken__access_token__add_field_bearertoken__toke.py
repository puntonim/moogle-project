...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BearerToken._access_token'
        db.delete_column('tokens_bearertoken', '_access_token')

        # Adding field 'BearerToken._token_set'
        db.add_column('tokens_bearertoken', '_token_set',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BearerToken._access_token'
        db.add_column('tokens_bearertoken', '_access_token',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)

        # Deleting field 'BearerToken._token_set'
        db.delete_column('tokens_bearertoken', '_token_set')
    ...
    models = {
        ...
        'tokens.bearertoken': {
            ...
            '_token_set': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
